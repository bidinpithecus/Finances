...
//    public Spent(int index, String name, Calendar date, String description, float value, Category category) {
		...
		nameField.setFont(MyFonts.H2.getFont());
		...
		descriptionField.setFont(MyFonts.H2.getFont());
		...
		dateField.setFont(MyFonts.H2.getFont());
		...
		valueField.setFont(MyFonts.H2.getFont());
